...
const scriptsDir = path.resolve(process.cwd(),'tools', 'builder', 'core');
...
// external templates
runScript(path.join(scriptsDir, 'merge-templates.js'), 'Merging HTML templates in JavaScript files...');
// internal templates
