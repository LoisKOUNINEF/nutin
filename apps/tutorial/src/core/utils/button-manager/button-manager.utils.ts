...
export class ButtonManager {
  ...
  private createButton(config: BaseButton, index: number): HTMLElement {
    ...
    AttributesHelper.setContent(button, config);
    AttributesHelper.setStyle(button, config);
    AttributesHelper.setPipes(button, config);
  ...
  private setDataEvent(button: HTMLButtonElement, index: number) {
