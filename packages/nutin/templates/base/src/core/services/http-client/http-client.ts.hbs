...
export class HttpClient extends Service<HttpClient> {
  ...
  public addRequestInterceptor(fn: (url: string, options: RequestInit) => void) {
    this._requestInterceptors.push(fn);
  }

  public addResponseInterceptor(fn: (response: Response) => void) {
  ...
  public get<T = unknown>(endpoint: string, config?: IRequestConfig) { 
    return this.request<T>('GET', endpoint, null, config);
  }
  public post<T = unknown>(endpoint: string, data?: unknown, config?: IRequestConfig) { 
    return this.request<T>('POST', endpoint, data, config);
  }
  public put<T = unknown>(endpoint: string, data?: unknown, config?: IRequestConfig) { 
    return this.request<T>('PUT', endpoint, data, config);
  }
  public patch<T = unknown>(endpoint: string, data?: unknown, config?: IRequestConfig) { 
    return this.request<T>('PATCH', endpoint, data, config);
  }
  public delete<T = unknown>(endpoint: string, config?: IRequestConfig) { 
